...
dataFromFunction = function_name()          # when assign function to variable, it back her return
...
print(myList)
print(*myList)          # *list == call thier items
                        # *parametres = call all variables == our func will take any number of parameters,
                        # and we treat them as list items
...
def show_skills(*skills):                   # NOTE: skills class == tuple
...
def show_skills(**skills):      ## when we deal with dict we need ** not only *
...
show_skills("Osama", *myTuple, **mySkills)                # calling tuple with dict, by variables of them
...
def one():
  ...
  global x            # when call it in finction, if adjust it the change will be saved
...
def cleanWord(word):                # you can use your function in itself
...
print(say_hello.__name__)            ## what function named ;  .__name__
print(hello.__name__)

print(type(hello))                  ## function classs
