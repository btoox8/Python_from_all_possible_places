...
##
#غير مكتمله ولا متقنه
# def month_days(month,number_days):
#     if (month == "June" or month=='june') and number_days == 30:
#         print("June has 30 days")
#     elif (month =='July' or month == 'july') and number_days == 31:
...
def is_positive(number):
    if number > 0:
        ...
        return False  ## if we not use else , our result is None
